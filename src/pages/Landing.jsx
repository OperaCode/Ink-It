...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-950 text-white scroll-smooth font-sans">
      ...
      {/* Hero Section */}
      <section id="home" className="relative flex flex-col justify-center items-center h-screen bg-gradient-to-br from-cyan-900 via-purple-900 to-gray-900 pt-20 text-center px-4">
        <motion.h1
      ...
      <section id="features" className="py-20 px-6 bg-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            { title: "Organize Notes", desc: "Structure your thoughts seamlessly with folders, tags, and lock features." },
            { title: "Secure Ideas", desc: "Lock confidential notes with PIN encryption for ultimate privacy." },
            { title: "Custom Themes", desc: "Personalize your writing space with elegant themes and dark mode." },
          ].map((feature, index) => (
            <motion.div
              key={index}
              whileHover={{ scale: 1.05 }}
      ...
      <section id="testimonials" className="py-20 px-6 bg-gradient-to-br from-gray-900 to-gray-800">
        <motion.h2
          initial={{ y: -20, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.6 }}
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <p className="text-lg italic text-gray-300">
              “InkPulse transformed the way I capture and refine my ideas. It's now my daily companion for structured thinking.”
            </p>
